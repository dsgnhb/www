    ...
    <div>
      <section id="imprint-intro">
        <div className="container">
          <MainTitle title="Impressum" link="/privacypolicy" linktitle="Was wir mit deinen Daten so alles machen 😏 (Datenschutzerklärung)" />
        </div>
      </section>
      <section id="imprint-contact">
        <div className="container">
          ...
          <p>
            Florentin Walter<br />Breslauerstraße 12<br />63927 Bürgstadt
          </p>
          <h3>Kontakt:</h3>
          <p>
            Telefon: +49 176 47397970<br />E-Mail: <Link to="mailto:info@dsgnhb.de">info@dsgnhb.de</Link>
          </p>
        </div>
      </section>
