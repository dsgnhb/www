      ...
      <section id="partner">
        <div className="container">
          <MainTitle title="Danke." subtitle="Partner" link="/discord" linktitle="Falls Du uns auch unterstützen möchtest, kannst Du das hier tun!">
            Dank unserer Partner, die uns stets unterstützen, können wir das Projekt aktiv halten. Hier findest du alle Informationen rund um sämtliche aktive Partnerschaften. Solltest du das
