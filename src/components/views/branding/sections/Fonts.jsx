    ...
    <section id="fonts">
      <div className="container">
        <SectionTitle subtitle="Fonts" title="AaBbCcDd">
          Die Schriftart "Proxima Nova" wurde für die Verwendung sorgfällig ausgewählt,um ein konsistentes Erscheinungsbild in allen Online- und Printanwendungen zu gewährleisten.
        </SectionTitle>
