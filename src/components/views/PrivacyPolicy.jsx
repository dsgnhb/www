        ...
        <div>
            ...
            <section id="privacypolicy">
                <div className="container">
                    ...
                    <h3>Piwik</h3>
                    <p>
                        Diese Website benutzt den Open Source Webanalysedienst Piwik. Piwik verwendet so genannte
                        ...
                        wird vor der Speicherung anonymisiert. Die durch den Cookie erzeugten Informationen über die
                        Benutzung dieser Website werden nicht an Dritte weitergegeben. Sie können die Speicherung der
                        ...
                        Website vollumfänglich werden nutzen können. Wenn Sie mit der Speicherung und Nutzung Ihrer
                        Daten nicht einverstanden sind, können Sie die Speicherung und Nutzung hier deaktivieren. In
                        diesem Fall wird in Ihrem Browser ein Opt-Out-Cookie hinterlegt der verhindert, dass Piwik
                        Nutzungsdaten speichert. Wenn Sie Ihre Cookies löschen hat dies zur Folge, dass auch das Piwik
                        Opt-Out-Cookie gelöscht wird. Das Opt-Out muss bei einem erneuten Besuch unserer Seite wieder
                        aktiviert werden.
                    </p>
                    ...
                    <p>
                        designhub benutzt Anwendungen, Webseiten und Dienste Dritter, um Ihnen Inhalte und/oder Dienste
                        zur Verfügung zu stellen. Anwendungen Dritter können eigenen Nutzungsbedingungen und
                        Datenschutzbestimmungen unterliegen, in denen Ihre Nutzung dieser Anwendungen Dritter geregelt
                        wird, und deren Nutzungsbedingungen und Datenschutzbestimmungen diese Verantwortung oder
                        Haftung für das Verhalten, die Funktionen oder Inhalte irgendeiner Anwendung Dritter oder für
                        irgendeine Transaktion, die Sie mit dem Anbieter dieser Anwendungen Dritter eingehen,
                        übernimmt.
                    </p>
                    ...
                    <p>
                        ...
                        ein Recht
                        auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema
