    ...
    <section id="intro">
      <div className="container">
        <MainTitle subtitle="Hey!" title="Wir sind Designhub&trade;" link="/discord" linktitle="Komm auf unseren Discord">
          Designhub bringt talentierte Designer und Developer zu einer großen Community zusammen. Komm jetzt auf unseren Discord, um deine kreative Arbeit zu präsentieren, Neues zu entdecken oder halt
