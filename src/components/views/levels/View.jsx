      ...
      <section id="leaderboard">
        <div className="container">
          <MainTitle title="Leaderboard" subtitle="Levels">
            ...
            <br />
            <h3>Chest-System</h3>
            Jedes mal, wenn ihr eine gerade Levelanzahl erreicht, bekommst du automatisch eine neue Chest, die du mit !chest öffnen kannsst. Darin erwarten dich *hust*TOLLE *hust* Überraschungen, wie
