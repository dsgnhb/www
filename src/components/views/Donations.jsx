  ...
  render() {
    return (
      <div>
        ...
        >
          Da wir für Deine Spenden lieber auf ein komplexes Zahlungssystem mit hohen Gebühren/Abgaben verzichten, kontaktiere einfach
          <b>Flo (flo#3087)</b>
        ...
        <div id="intro">
          <div className="content">
            <Text>
              ...
              und alles andere, was halt sonst noch so Geld kostet. - <em>Und kostenlose Mega-Op Sachen für die Admins natürlich.</em>
              <i className="twa twa-lg twa-smirk" />
            </Text>
            <Text>Falls du uns unterstützen und das Projekt aufrecht erhalten möchtest, freuen wir uns über jede Hilfe!</Text>
            <DiscordLink />
          </div>
        </div>
        <div id="donate">
          <div className="content">
            ...
            <Text title="Letzte Donations">
              Vielen Dank an:<br />
              - <a href="https://www.gommehd.net">@Teax</a>
              <br />
